...
public final class Tools {
    ...
    public static String APP_NAME = "Pokefree";

    public static final Gson GLOBAL_GSON = new GsonBuilder().setPrettyPrinting().create();

    public static final String URL_HOME = "https://www.pokefree.fr";
    ...
    public static final String LAUNCHERPROFILES_RTPREFIX = "pokefree://";

    // New since 3.3.1
    public static String DIR_ACCOUNT_NEW;
    public static String DIR_GAME_HOME = Environment.getExternalStorageDirectory().getAbsolutePath() + "/games/Pokefree";
    ...
    private static File getPojavStorageRoot(Context ctx) {
        if(SDK_INT >= 29) {
            ...
            return new File(Environment.getExternalStorageDirectory(),"games/Pokefree");
        }
    }
